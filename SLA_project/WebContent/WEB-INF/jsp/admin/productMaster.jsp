			...
			<div class="col-md-6" class="table-responsive">
				...
				<div class="panel panel-default" >
					<div class="panel-body">
						...
						<tr>
						<td>Product Id: </td>
						<td><input type="text" name="productId" class="input-sm" value="${productMast.productId}" readonly></td>
						</tr>
						<tr>
						<td>Product Name : </td>
						<td><input type="text" name="productName" class="input-sm"></td>
						</tr>
						<tr>
						<td>Phase : </td>
						<td><input type="text" name="phase" class="input-sm"></td>
						</tr>
						<tr>
						<td>Warranty : </td>
						<td><input type="text" name="warranty" class="input-sm"></td>
						</tr>
						<tr>
						<td>Model Name : </td>
					  ...
					  <option value="${modelDetails.modelName}" >${modelDetails.modelName}</option>
						...
						<a href="getProduct" class="btn btn-primary btn-primary-spacing">Show Product</a>
