					...
					<div class="panel-body">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<core:forEach items="${locationList}" var="locationList">
									<tr>
										<td>${locationList.locationId}</td>
										<td>${locationList.locationName}</td>
										<td><a href="editLocation?locationId=${locationList.locationId}"><img src="resources/bootstrap/images/edit.png" width="25px" height="25px"></a></td>
										
		<td><a href="deleteLocation?locationId=${locationList.locationId}">Delete</a></td>
										</tr>
										</core:forEach>
							</table>
						</div>
