			...
			<div class="col-md-6" class="table-responsive">
				...
				<div class="panel panel-default" >
					<div class="panel-body">
						...
						<tr>
						<td>Unit Id: </td>
						<td><input type="text" name="unitId" class="input-sm" value="${unitMas.unitId}" ></td>
						</tr>
						<tr>
						<td>Symbol : </td>
						<td><input type="text" name="symbol" class="input-sm"></td>
						</tr>
						</table><hr>
						...
						<a href="getUnit" class="btn btn-primary btn-primary-spacing">Get Customer</a>		
						</form:form>
						</div>
