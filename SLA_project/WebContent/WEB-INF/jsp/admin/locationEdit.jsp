			...
			<div class="col-md-6" class="table-responsive">
				...
				<div class="panel panel-default" >
					<div class="panel-body">
						...
						<tr>
						<td>Location Id: </td>
						<td><input type="text" name="locationId" class="input-sm" value="${location.locationId}" readonly></td>
						</tr>
						<tr>
						<td>Location Name : </td>
						<td><input type="text" name="locationName" class="input-sm" value="${location.locationName}"></td>
						</tr>
						</table>
						<hr>
