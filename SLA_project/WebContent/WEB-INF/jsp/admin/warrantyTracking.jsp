		...
		<div class="col-md-7">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<tr>
					<td>House No</td>
					<td><input type="text" class="input-sm" id="houseNo" name="houseNo" readonly></td>
					<td>Doc Date</td>
					<td><input type="date" class="input-sm"  name="docDate"></td>
					</tr>
					<tr>
					<td>Society</td>
					<td><input type="text" class="input-sm" id="society" name="society" readonly></td>
					<td>Locality</td>
					<td><input type="text" class="input-sm" id="locality" name="locality" readonly></td>
					</tr>
					<tr>
					<td>City</td>
					<td><input type="text" class="input-sm" id="city" name="city" readonly></td>
					<td>State</td>
					<td><input type="text" class="input-sm" id="state" name="state" readonly></td>
					</tr>
					<tr>
					<td>Product Name</td>
					...
					<td>Purchase Date</td>
					<td><input type="date" class="input-sm" name="purchaseDate"></td>
					</tr>
					<tr>
					<td>Dispatch Date</td>
					<td><input type="date" class="input-sm" name="dispatchDate"></td>
					<td>Equipment Sr. No</td>
					<td><input type="text" class="input-sm" name="eqtSrNo"></td>
					</tr>
					<tr>
					<td></td>
					<td></td>
					<td>Mgr Sr.No</td>
					<td><input type="text" class="input-sm" name="mgrSrNo"></td>
					</tr>
					<tr>
					<td>Install Date</td>
					<td><input type="date" class="input-sm" name="installDate"></td>
					<td>New Warranty Date</td>
					<td><input type="text" class="input-sm" name="newWarrenty"></td>
					</tr>
					<tr>
					<td>Gross Exp</td>
					<td><input type="text" class="input-sm" name="grossExp"></td>
					<td>Expiry Date</td>
					<td><input type="text" class="input-sm" name="expiryDate"></td>
					</tr>
