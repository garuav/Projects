...
<table class="table" width="100%">
	...
	<core:forEach items="${productList}" var="productList">
		<tr><td>${productList.productId}</td>
		<td>${productList.productName}</td>
		<td>${productList.phase}</td>
		<td>${productList.warranty}</td>
		<td>${productList.modelName}</td>
		<td><a href="editProduct?productId=${productList.productId}"><img src="resources/bootstrap/images/edit.png" width="25px" height="25px"></a></td>
		<td><a href="deleteProduct?productId=${productList.productId}">Delete</a></td>
