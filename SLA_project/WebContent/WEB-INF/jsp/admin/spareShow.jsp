					...
					<div class="panel-body">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<core:forEach items="${spareList}" var="spareList">
									<tr>
										<td>${spareList.spareId}</td>
										<td>${spareList.spareName}</td>
										<td>${spareList.rate}</td>
										<td>${spareList.unit}</td>
										<td><a href="editSpare?spareId=${spareList.spareId}"><img src="resources/bootstrap/images/edit.png" width="25px" height="25px"></a></td>
										
		<td><a href="deleteSpare?spareId=${spareList.spareId}">Delete</a></td>
										</tr>
										</core:forEach>
							</table>
						</div>
